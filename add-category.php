...
$query=mysqli_query($con,"insert into tblcategory(Kategoria) value('$category')");

    if ($query) {
    echo '<script>alert("Kategoria u regjistrua me sukses")</script>';
	...
	<div id="right-panel" class="right-panel">
        ...
        <!-- /. NAV SIDE  -->        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Kategoria
                        	<!--
						 <a href="dashboard.php" class="btn btn-primary btn-sm pull-right">Back <i class="glyphicon glyphicon-arrow-right"></i></a>						</h1>
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="category" 
									  ...
									  data-validation-error-msg="Ju lutem shkruani nje kategori(min 4 shkronja)"
									  />
								</div>
							</div>
