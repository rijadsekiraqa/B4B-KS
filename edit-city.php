...
$city=$_POST['city'];
 $query=mysqli_query($con,"update tblcity set Qyteti='$city' where  ID='$eid'");

    if ($query) {
    echo '<script>alert("Qyteti u perditesua me sukses")</script>';
...
<body>
 ...
 <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  tblcity where ID='$cid'");
$cnt=1;
...
?>
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="city" value="<?php  echo $row['Qyteti'];?>" class="form-control" id="city" required="true" readonly="">
                                </div>
                                    </div>
